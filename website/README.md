...
- root `SKILL.md` as the only installable discovery stub for `npx skills add telegraphic-dev/jbx`; command-specific skills are served by the binary, not exposed statically
